...
public class AstorgosuchusAdultSkeleton7 extends EntityModel<Entity> {
    ...
    public AstorgosuchusAdultSkeleton7() {
        textureWidth = 256;
        textureHeight = 256;

        Astargosuchus = new ModelRenderer(this);
        Astargosuchus.setRotationPoint(0.0F, 4.0F, 8.0F);


        Body = new ModelRenderer(this);
        Body.setRotationPoint(0.0F, 0.0F, 0.0F);
        Astargosuchus.addChild(Body);
        setRotationAngle(Body, 0.0F, 0.1745F, 0.0F);
        ...
        Body.addChild(Head);
        setRotationAngle(Head, 0.035F, 0.2197F, -0.035F);
        ...
        Body.addChild(Tail);
        setRotationAngle(Tail, 0.0F, 0.1745F, 0.0F);
        ...
        setRotationAngle(RightArm, 1.2654F, 0.0F, 0.0F);
        ...
        setRotationAngle(LeftLeg, 1.309F, 0.0F, 0.0F);
        ...
        setRotationAngle(RightLeg, 1.1781F, 0.0F, 0.0F);
