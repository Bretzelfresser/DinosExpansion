...
public class AstorgosuchusAdultSkeleton6 extends EntityModel<Entity> {
    ...
    public AstorgosuchusAdultSkeleton6() {
        textureWidth = 256;
        textureHeight = 256;

        Astargosuchus = new ModelRenderer(this);
        Astargosuchus.setRotationPoint(0.0F, 15.0F, 8.0F);


        Body = new ModelRenderer(this);
        Body.setRotationPoint(0.0F, 0.0F, 0.0F);
        Astargosuchus.addChild(Body);
        setRotationAngle(Body, 0.0F, 0.0436F, 0.0F);
