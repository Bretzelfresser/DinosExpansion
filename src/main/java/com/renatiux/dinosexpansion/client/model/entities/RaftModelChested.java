...
public class RaftModelChested extends EntityModel<RaftEntity>{
	...
	public RaftModelChested() {
		...
		chest.setRotationPoint(-5.0F, 0.0F, 10.0F);
		body.addChild(chest);
		chest.setTextureOffset(0, 0).addBox(-3.0F, -8.0F, -4.0F, 6.0F, 6.0F, 6.0F, 0.0F, false);
		chest.setTextureOffset(0, 0).addBox(3.0F, -7.0F, -2.0F, 1.0F, 3.0F, 2.0F, 0.0F, false);
