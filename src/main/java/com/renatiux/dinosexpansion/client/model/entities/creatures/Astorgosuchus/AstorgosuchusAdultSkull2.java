...
public class AstorgosuchusAdultSkull2 extends EntityModel<Entity> {
    private final ModelRenderer Head;
    private final ModelRenderer Jaw;

    public AstorgosuchusAdultSkull2() {
        textureWidth = 128;
        textureHeight = 128;
        ...
        Jaw.setRotationPoint(0.0F, 3.0F, 16.0F);
        Head.addChild(Jaw);
        Jaw.setTextureOffset(0, 0).addBox(-4.75F, 1.025F, -19.425F, 9.0F, 3.0F, 19.0F, 0.0F, false);
        Jaw.setTextureOffset(37, 3).addBox(-4.75F, 0.025F, -19.525F, 9.0F, 1.0F, 19.0F, 0.0F, false);
    }
