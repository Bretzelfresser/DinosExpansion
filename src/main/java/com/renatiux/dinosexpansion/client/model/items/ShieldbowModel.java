...
public class ShieldbowModel extends EntityModel<Entity> {
    ...
    public ShieldbowModel() {
        ...
        bone.setTextureOffset(22, 4).addBox(-6.0F, -7.0F, -2.0F, 9.0F, 4.0F, 1.0F, 0.0F, false);
        bone.setTextureOffset(22, 9).addBox(-18.0F, -7.0F, -2.0F, 9.0F, 4.0F, 1.0F, 0.0F, false);
        ...
        bone.setTextureOffset(36, 23).addBox(-14.0F, -13.0F, -3.5F, 5.0F, 1.0F, 2.0F, 0.0F, false);
        bone.setTextureOffset(36, 20).addBox(-6.0F, -13.0F, -3.5F, 5.0F, 1.0F, 2.0F, 0.0F, false);

        cube_r1 = new ModelRenderer(this);
        cube_r1.setRotationPoint(-7.5F, -4.5F, 14.0F);
        bone.addChild(cube_r1);
        setRotationAngle(cube_r1, -0.3927F, 0.0F, 0.0F);
        cube_r1.setTextureOffset(36, 26).addBox(-1.5F, 0.0F, 1.0F, 3.0F, 3.0F, 2.0F, 0.0F, false);
        cube_r1.setTextureOffset(36, 14).addBox(-1.0F, 0.5F, -3.0F, 2.0F, 2.0F, 4.0F, 0.0F, false);

        cube_r2 = new ModelRenderer(this);
        cube_r2.setRotationPoint(-8.5F, -5.25F, 9.5F);
        bone.addChild(cube_r2);
        setRotationAngle(cube_r2, 0.0F, -0.7854F, 0.0F);
        cube_r2.setTextureOffset(22, 2).addBox(-14.0F, -0.5F, 0.0F, 15.0F, 1.0F, 1.0F, 0.0F, false);

        cube_r3 = new ModelRenderer(this);
        cube_r3.setRotationPoint(-6.5F, -5.25F, 9.5F);
        bone.addChild(cube_r3);
        setRotationAngle(cube_r3, 0.0F, 0.7854F, 0.0F);
        cube_r3.setTextureOffset(22, 0).addBox(-1.0F, -0.5F, 0.0F, 15.0F, 1.0F, 1.0F, 0.0F, false);

        cube_r4 = new ModelRenderer(this);
        cube_r4.setRotationPoint(2.5F, -5.4F, -0.5F);
        bone.addChild(cube_r4);
        setRotationAngle(cube_r4, 0.0F, -0.3927F, 0.0F);
        cube_r4.setTextureOffset(0, 35).addBox(-2.5F, -1.5F, -0.5F, 7.0F, 3.0F, 1.0F, 0.0F, false);

        cube_r5 = new ModelRenderer(this);
        cube_r5.setRotationPoint(-17.5F, -5.4F, -0.5F);
        bone.addChild(cube_r5);
        setRotationAngle(cube_r5, 0.0F, 0.3927F, 0.0F);
        cube_r5.setTextureOffset(16, 36).addBox(-5.5F, -1.5F, -0.5F, 7.0F, 3.0F, 1.0F, 0.0F, false);
    }
