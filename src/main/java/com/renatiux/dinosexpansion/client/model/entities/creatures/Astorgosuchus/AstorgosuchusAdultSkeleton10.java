...
public class AstorgosuchusAdultSkeleton10 extends EntityModel<Entity> {
    ...
    public AstorgosuchusAdultSkeleton10() {
        textureWidth = 256;
        textureHeight = 256;

        Astargosuchus = new ModelRenderer(this);
        Astargosuchus.setRotationPoint(-1.0F, 11.0F, 9.0F);


        Body = new ModelRenderer(this);
        Body.setRotationPoint(0.0F, 0.0F, 0.0F);
        Astargosuchus.addChild(Body);
        setRotationAngle(Body, -0.2237F, -0.3477F, 0.0317F);
        ...
        Head.setRotationPoint(0.0F, -0.6F, -21.3F);
        Body.addChild(Head);
        setRotationAngle(Head, -0.48F, -0.2618F, 0.0F);
        ...
        Body.addChild(Tail);
        setRotationAngle(Tail, 0.0873F, 0.5672F, 0.0F);
        ...
        setRotationAngle(LeftArm, 0.3054F, 0.0F, -0.1309F);
