...
public class OreGeneration {
    ...
    public static void addOres(final BiomeLoadingEvent event){
        ...
        addOre(event, OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, BlockInit.DINO_BROWNSTONE_ORE.get().getDefaultState(), 10, 0, 64, 20);
        addOre(event, OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, BlockInit.DINO_PURPLE_GEN_ORE.get().getDefaultState(), 6, 0, 16, 8);
