...
public class FoodInit {
	...
	public static final Food WHALE_COOKED_MEAT = new Food.Builder().hunger(3).saturation(0.3F).meat().build();
	public static final Food WHALE_RAW_MEAT = new Food.Builder().hunger(8).saturation(0.8F).meat().build();
