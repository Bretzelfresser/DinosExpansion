...
public class EntityTypeInit {
	...
	public static final RegistryObject<EntityType<RegularBoomerang>> REGULAR_BOOMERANG = ENTITY_TYPES.register("regular_boomerang", 
			() -> EntityType.Builder.<RegularBoomerang>create(RegularBoomerang::new, EntityClassification.MISC).build(Dinosexpansion.modLoc("regular_boomerang").toString()));
}
