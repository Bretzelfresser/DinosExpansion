...
public class ItemInit {
	...
	public static final RegistryObject<Item> NARCOTIC_BERRY = AUTOGENERATED_ITEMS.register("narcotic_berry", () -> new DENarcoticBlock(BlockInit.NARCOTIC_BERRY_BUSH.get(), new Item.Properties().group(ItemGroupInit.MISC).food(FoodInit.NARCOTIC_BERRY), 10));
