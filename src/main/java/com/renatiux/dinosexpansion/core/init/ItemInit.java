...
import com.renatiux.dinosexpansion.common.items.enzyclopedia.EnzyklopediaBook;
...
public class ItemInit {
	...
	//enzyclpedia
	public static final RegistryObject<Item> ENZYCLIPEDIA = ITEMS.register("encyclopedia", EnzyklopediaBook::new);
	...
	public static final RegistryObject<Item> XENOCRANIUM_SPAWN_EGG = ITEMS.register("xenocranium_spawn_egg", ()-> new CustomSpawnEgg(EntityTypeInit.XENOCRANIUM, 13140819, 3481088, new Item.Properties().group(ItemGroupInit.MISC)));
	public static final RegistryObject<Item> ASTORGOSUCHUS_SPAWN_EGG = ITEMS.register("astorgosuchus_spawn_egg", ()-> new CustomSpawnEgg(EntityTypeInit.ASTORGOSUCHUS, 13140819, 3481088, new Item.Properties().group(ItemGroupInit.MISC)));
	public static final RegistryObject<Item> WHETERELLUS_SPAWN_EGG = ITEMS.register("wheterellus_spawn_egg", ()-> new CustomSpawnEgg(EntityTypeInit.WHETERELLUS, 13140819, 3481088, new Item.Properties().group(ItemGroupInit.MISC)));
	...
	public static final RegistryObject<Item> URANIUM_INGOT = AUTOGENERATED_ITEMS.register("uranium_ingot", () -> new Item( new Item.Properties().group(ItemGroupInit.MISC)));
	public static final RegistryObject<Item> URANIUM_SCRAP = AUTOGENERATED_ITEMS.register("uranium_raw", () -> new Item( new Item.Properties().group(ItemGroupInit.MISC)));
	//Armor
