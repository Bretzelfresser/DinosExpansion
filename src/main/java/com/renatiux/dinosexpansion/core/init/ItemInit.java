...
public class ItemInit {
	...
	public static final RegistryObject<Item> BOOMERANG = AUTOGENERATED_ITEMS.register("boomerang", () -> new BoomerangItem(new Item.Properties().group(ItemGroupInit.PROJECTILES)));
