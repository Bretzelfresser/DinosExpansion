...
public class SkeletalAssemblyContainer extends BaseTileEntityContainer<SkeletalAssemblyTableTile> {


    public SkeletalAssemblyContainer(int id, PlayerInventory inv, SkeletalAssemblyTableTile tileEntity) {
        super(ContainerTypeInit.SKELETAL_ASSEMBLY_CONTAINER.get(), id, inv, tileEntity);
    }

    public SkeletalAssemblyContainer(int id, PlayerInventory inv, PacketBuffer buffer) {
        super(ContainerTypeInit.SKELETAL_ASSEMBLY_CONTAINER.get(), id, inv, buffer);
    }
    ...
    public void init() {
        ...
        addSlotField(tileEntity, 0, 12, 17, 5, 18, 5, 18);
        addSlot(new ResultSlot(tileEntity, 25, 144, 55));
    }
