...
public class HammerItem extends PickaxeItem {
    ...
    public HammerItem(IItemTier tier, int attackDamageIn, float attackSpeedIn, Properties builder, Supplier<Ingredient> customRepair) {
    ...
    public boolean onBlockDestroyed(ItemStack stack, World world, BlockState state, BlockPos pos, LivingEntity entityLiving) {
        stack.attemptDamageItem(DEModConfig.TOOL_CONFIG.hammerDuraLossMulti.get()-1, DEModConfig.random, null);
