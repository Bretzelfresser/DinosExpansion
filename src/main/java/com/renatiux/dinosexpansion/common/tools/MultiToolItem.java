...
public class MultiToolItem extends ToolItem {
    ...
    public MultiToolItem(IItemTier material, float damage, float speed, Item.Properties builder) {
        super(damage, speed, material, EFFECTIVE_ON, builder.addToolType(net.minecraftforge.common.ToolType.AXE, material.getHarvestLevel()).addToolType(net.minecraftforge.common.ToolType.PICKAXE, material.getHarvestLevel()).addToolType(net.minecraftforge.common.ToolType.SHOVEL, material.getHarvestLevel()).maxStackSize(1));
    ...
    static {
        ...
        BLOCK_STRIPPING_MAP = (new ImmutableMap.Builder<Block, Block>()).put(Blocks.OAK_WOOD, Blocks.STRIPPED_OAK_WOOD)
                ...
                .put(BlockInit.PALM_LOG.get(), BlockInit.STRIPPED_PALM_LOG.get()).put(BlockInit.PALM_WOOD.get(), BlockInit.STRIPPED_PALM_WOOD.get())
                .build();
