...
public class DETreeConfig implements IFeatureConfig {

    public static final Codec<DETreeConfig> CODEC = RecordCodecBuilder.create((codecRecorder) -> {
    ...
    DETreeConfig(BlockStateProvider trunkProvider, BlockStateProvider leavesProvider, BlockStateProvider groundReplacementProvider, BlockStateProvider diskProvider, int minHeight, int maxHeight, int diskRadius, List<BlockState> whitelist) {
