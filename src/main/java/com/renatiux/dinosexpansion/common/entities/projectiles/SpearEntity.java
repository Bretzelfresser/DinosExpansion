...
public class SpearEntity extends AbstractArrowEntity {
    ...
    protected ResourceLocation texture = new ResourceLocation(Dinosexpansion.MODID, "textures/entity/spear/wooden_spear.png");

    public SpearEntity(EntityType<? extends SpearEntity> spear, World world) {
        super(spear, world);
    }

    public SpearEntity(World worldIn, LivingEntity thrower, ItemStack thrownStackIn) {
        super(EntityTypeInit.SPEAR_ENTITY.get(), thrower, worldIn);
