...
public class Opabinia extends WaterMobEntity implements IAnimatable {
    ...
    public Opabinia(EntityType<? extends WaterMobEntity> type, World world) {
        super(type, world);
    ...
    private PlayState predicate(AnimationEvent<Opabinia> event) {

        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.opabinia.swim", true));
