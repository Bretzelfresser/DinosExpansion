...
public class Snowy extends BiomeBase {
    ...
    {
        return ModBiomeMaker.create(Biome.RainType.SNOW, Biome.Category.FOREST, 0.2F,  0.2F, -0.5F, 0.9F, 4159204, 329011, 12638463, BiomeBase.calcSkyColor(0.8F), 8896351, 8896351, MOB_SPAWNS.build(), GENERATION.build());
    }

    public static Biome create(float depth, float scale)
    {
        return ModBiomeMaker.create(Biome.RainType.SNOW, Biome.Category.FOREST, depth, scale, -0.5F, 0.9F, 4159204, 329011, 12638463, BiomeBase.calcSkyColor(0.8F), 8896351, 8896351, MOB_SPAWNS.build(), GENERATION.build());
    }
