...
public class Jungle extends BiomeBase {
    ...
    {
        return ModBiomeMaker.create(Biome.RainType.RAIN, Biome.Category.JUNGLE, 0.1F,  0.2F, 0.95F, 0.9F, 4159204, 329011, 12638463, BiomeBase.calcSkyColor(0.95F), MOB_SPAWNS.build(), GENERATION.build());
    }

    public static Biome create(float depth, float scale)
    {
        return ModBiomeMaker.create(Biome.RainType.RAIN, Biome.Category.JUNGLE, depth, scale, 0.95F, 0.9F, 4159204, 329011, 12638463, BiomeBase.calcSkyColor(0.95F), MOB_SPAWNS.build(), GENERATION.build());
    }
