...
public class Ocean extends BiomeBase {
    ...
    static void addGeneration()
    {
        ...
        GENERATION.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Features.SEAGRASS_NORMAL);
    }

    public static Biome create()
    {
        return ModBiomeMaker.create(Biome.RainType.RAIN, Biome.Category.OCEAN, -1.0F, 0.1F, 0.5F, 0.5F, 4159204, 329011, 12638463, BiomeBase.calcSkyColor(0.5F), MOB_SPAWNS.build(), GENERATION.build());
    }
}
