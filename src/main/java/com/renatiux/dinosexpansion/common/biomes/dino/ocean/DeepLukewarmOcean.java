...
public class DeepLukewarmOcean extends BiomeBase {
    ...
    public static Biome create() {
        return ModBiomeMaker.create(Biome.RainType.RAIN, Biome.Category.OCEAN, -1.8F, 0.1F, 0.5F, 0.5F, 4566514, 267827, 12638463, BiomeBase.calcSkyColor(0.5F), MOB_SPAWNS.build(), GENERATION.build());
    }
