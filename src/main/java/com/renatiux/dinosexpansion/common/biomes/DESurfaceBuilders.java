...
public class DESurfaceBuilders {
    ...
    public static final SurfaceBuilderConfig SILT_CONFIG = new SurfaceBuilderConfig(BlockInit.DINO_SAND.get().getDefaultState(), BlockInit.DINO_SAND.get().getDefaultState(), BlockInit.DINO_SAND.get().getDefaultState());
