...
public class DESurfaceBuilders {
    ...
    public static final SurfaceBuilderConfig DINO_SAND_CONFIG = new SurfaceBuilderConfig(Blocks.SAND.getDefaultState(), Blocks.SAND.getDefaultState(), Blocks.SAND.getDefaultState());
