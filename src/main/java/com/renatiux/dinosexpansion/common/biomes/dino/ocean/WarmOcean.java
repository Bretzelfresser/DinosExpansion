...
public class WarmOcean extends BiomeBase {
    ...
    {
        return ModBiomeMaker.create(Biome.RainType.RAIN, Biome.Category.OCEAN, -1.0F, 0.1F, 0.5F, 0.5F, 4445678, 270131, 12638463, BiomeBase.calcSkyColor(0.5F), MOB_SPAWNS.build(), GENERATION.build());
    }
