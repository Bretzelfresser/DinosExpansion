...
public class CustomSpawnEgg extends SpawnEggItem{
	...
	protected static final List<CustomSpawnEgg> EGGS_TO_ADD = new ArrayList<>();
	...
	public CustomSpawnEgg(final RegistryObject<? extends EntityType<?>> entity, final int primaryColor,
